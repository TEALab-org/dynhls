...
impl EnumVTKBuilder1D {
    ...
    pub fn add_coord_set(&mut self, coord_set: &CoordSet<1>, y: f32, v: u8) {
    ...
    pub fn add_dynamic_boundary(
        &mut self,
        dynamic: &DynamicBoundary<1>,
        y: f32,
    ) {
        self.add_coord_set(dynamic.dilation_front.inside(), y, 0);
        self.add_coord_set(dynamic.dilation_front.outside(), y, 1);
        self.add_coord_set(dynamic.static_front.inside(), y, 2);
        self.add_coord_set(dynamic.static_front.outside(), y, 3);
    }
